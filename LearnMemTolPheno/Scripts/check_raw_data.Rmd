...
LM_proc <- read.table(file="../Data/HeatProc_Learn.txt", sep="\t", header=TRUE, stringsAsFactors = FALSE)
...
```{r}
write.table(ThermTol.keep,file= "../Data/ThermalTol_processed.txt",row.names=FALSE,sep="\t")

write.table(LL.set,file= "../Data/LearnMem_processed.txt",row.names=FALSE,sep="\t")
```
