...
There are four files. The raw data for Thermal Tolerance, the raw data for Learning and Memory, the Learning and Memory data processed through HeatCalc, and activity measurements from the acclimation period. 
...
#dates
#rda containing the date information for all RILs and groups
