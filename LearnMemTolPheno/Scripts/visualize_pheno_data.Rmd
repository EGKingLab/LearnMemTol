...
Torder <- rawdTT %>% group_by(patRIL) %>% summarise("Tmean"=mean(incapacitation))
Torder <- Torder[order(Torder$Tmean),]

rawdTT$Tname <- factor(as.character(rawdTT$patRIL), levels = Torder$patRIL)
...
#to save plot
ggsave(ThermTol_indi_points, file="../Plots/ThermTol_indi_points.pdf", width=3.5, height=2.5)
...
#to save plot
ggsave(ThermTol_indi_points, file="../Plots/ThermTol_indi_points_2.pdf", width=4, height=4)
