...
RNAi_phenototal <- read_excel("../ProcessedData/HeatPlate_autotrack/RNAi_PhenoTotal.xlsx")
str(RNAi_phenototal)
RNAi_phenototal[1:5,]

hist(RNAi_phenototal$Total_Flies_Phenotyed)


#look at genotypes that have less that 30 and more than 40 individuals 
