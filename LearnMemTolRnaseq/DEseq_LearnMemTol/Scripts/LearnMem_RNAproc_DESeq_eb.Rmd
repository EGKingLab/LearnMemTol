...
Learnres <- results(LMddsDE, contrast =c("treatment", "LH", "LL"))
Memres <- results(LMddsDE, contrast =c("treatment", "MH", "ML"))

#Sort by adjusted p-value and display
(LearnresOrdered <- Learnres[order(Learnres$padj), ])
(MemresOrdered <- Memres[order(Memres$padj), ])

 
#save(LearnresOrdered, file = "../Data/LearnresOrdered.Rda")
#save(MemresOrdered, file = "../Data/MemresOrdered.Rda")
...
LearnresSV <- results(LMsv_dds_deseq, contrast =c("treatment", "LH", "LL"))
MemresSV <- results(LMsv_dds_deseq, contrast =c("treatment", "MH", "ML"))
...
hist(Learnsv_res_dds_table$pvalue, breaks=50, col="grey")

# Examine independent filtering
metadata(Learnsv_res_dds_table)$filterThreshold

plot(metadata(Learnsv_res_dds_table)$filterNumRej, type="b", xlab="quantiles of baseMean", ylab="number of rejections")
```
