...
for (cc in condition)
{
  ...
  FC_HL <- lfcShrink(TTlrt_All_deseq, contrast=c("pool_con",paste("H_",cc,sep=""),paste("L_",cc,sep="")), type="normal")
  
  #FC_ <- lfcShrink(TTlrt_All_deseq, contrast=c("pool_con",paste("H_",cc,sep=""),paste("L_",cc,sep="")), type="normal")
