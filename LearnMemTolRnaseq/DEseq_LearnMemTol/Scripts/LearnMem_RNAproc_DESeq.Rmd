...
LearnMempheno_data$batch <- LearnMempheno_data$treatment

LearnMempheno_data$batch[LearnMempheno_data$treatment=='LL'] <- "1"
LearnMempheno_data$batch[LearnMempheno_data$treatment=='LH'] <- "1"
LearnMempheno_data$batch[LearnMempheno_data$treatment=='ML'] <- "2"
LearnMempheno_data$batch[LearnMempheno_data$treatment=='MH'] <- "2"
...
save(LearnMempheno_data, file="../Data/LearnMemRNAproc_data.rda")
