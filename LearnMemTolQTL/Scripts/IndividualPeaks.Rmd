...
Set which QTL to examine as ll. 
...
length(unique(ll.sub[which(ll.sub$padj_Pool_Overall <= 0.05),]$gname))
length(unique(ll.sub[which(ll.sub$padj_Cond_Overall <= 0.05),]$gname))


#Condition 
ll.sub[which.max(abs(ll.sub$FC_Cond_Overall)),]
ll.sub[which.min(ll.sub$padj_Cond_Overall),]
ll.sub[which(ll.sub$padj_Cond_Overall <= 0.05),]

unique(ll.sub[which(ll.sub$padj_Cond_Overall <= 0.05),]$gname)

#Pool
cc.ll <- ci.peak[[3]][ll,]
ll.sub <- ThermTol.list[[ll]]

ll.sub[which.max(abs(ll.sub$FC_Pool_Overall)),]
ll.sub[which.min(ll.sub$padj_Pool_Overall),]

ll.sub[which(ll.sub$padj_Pool_Overall <= 0.05),]

unique(ll.sub[which(ll.sub$padj_Pool_Overall <= 0.05),]$gname)
...
ll.sub[which.min(ll.sub$padj_Interaction_Overall),]

ll.sub[which(ll.sub$padj_Interaction_Overall <= 0.05),]

unique(ll.sub[which(ll.sub$padj_Interaction_Overall <= 0.05),]$gname)


```


## Q5 is annotated here
