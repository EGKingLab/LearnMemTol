...
Goal is to identify the founders effect at the QTLs for thermal tolerance. This data will be used to identify which RILs have low or high haplotype at Q5 and other peaks.
...
#visualize
Q5_eff_plot <- ggplot(T_all, aes(hard, Incapacitation_Mean)) +
...
stat_summary(fun.data = mean_se, 
  ...
  xlab("RIL Founder Haplotype ID at Q5") +
  my_theme

saveRDS(Q5_eff_plot, file = "../Plots/Fig3c.Rds")
ggsave(Q5_eff_plot, filename="../Plots/Q5_eff_plot.pdf", width=6, height=6)
