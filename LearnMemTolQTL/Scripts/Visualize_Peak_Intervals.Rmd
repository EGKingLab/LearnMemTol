...
ttpoolplots <- plot_grid(plotlist=ttpool.list, nrow=4, ncol=4,labels = c("a.","b.","c.","d.","e.","f.","g."), align="hv", axis="tl", rel_widths=c(3,1,1,1), rel_heights = c(1,1,1,2), label_size=10, hjust= c(rep(c(0,rep(-2,3)),3),0,-2,-2))
