...
pool_all <- plot_grid(plotlist=ttpool.plot.list[2:8], labels=paste0(LETTERS[1:7],"."), ncol=2, label_size = 10)
...
con_all <- plot_grid(plotlist=ttcon.plot.list[2:8], labels=paste0(LETTERS[1:7],"."), ncol=2, label_size = 10)
