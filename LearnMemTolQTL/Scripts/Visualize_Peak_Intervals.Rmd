...
ttallplots <- plot_grid(plotlist=ttmaster.list, nrow=4, ncol=4,labels = c("a.","b.","c.","d.","e.","f.","g.","h.","i.","j.","k.","l.","m.","n.","o.","p.","q.","r.","s.","t.","u.", ), align="hv", axis="tl", rel_widths=c(1,0.9,0.9,0.9), rel_heights = c(0.9,0.9,0.9,1), label_size=10, hjust= c(rep(c(0,rep(-2,3)),3),0,-2,-2))
...
ttpoolplots <- plot_grid(plotlist=ttpool.list, nrow=3, ncol=3,labels = c("a.","b.","c.","d.","e.","f.","g."), align="hv", axis="tl", rel_widths=c(3,1,1,1), rel_heights = c(1,1,1,2), label_size=5, hjust= c(rep(c(0,rep(-2,3)),3),0,-2,-2))


#QTLs CI for condition
...
ttconplots <- plot_grid(plotlist=ttcon.plot.list, nrow=2, ncol=2,labels = c("a.","b.","c.","d.","e.","f.","g."), align="hv", axis="tl", rel_widths=c(3,1,1,1), rel_heights = c(1,1,1,2), label_size=10, hjust= c(rep(c(0,rep(-2,3)),3),0,-2,-2))
