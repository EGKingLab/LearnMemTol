...
tt.set.s <- tt.set[is.na(tt.set$l2F_pool + tt.set$l2F_con + tt.set$l2F_pool)==FALSE,]
tt.set.s$sig <- 'N'
tt.set.s$sig[tt.set.s$padj_con + tt.set.s$padj_inter + tt.set.s$padj_pool<=0.05]<-'Y'
...
Q6 <- ggplot(tt.set.s[tt.set.s$sig=='N',], aes(midM, l2F_pool, label=labelrep))+
  geom_segment(data=tt.set.s[tt.set.s$sig=='Y',], x=tt.set.s[tt.set.s$sig=='Y','startp']/1e6, xend=tt.set.s[tt.set.s$sig=='Y','stopp']/1e6, y=tt.set.s[tt.set.s$sig=='Y','log2FoldChange'],yend=tt.set.s[tt.set.s$sig=='Y','log2FoldChange'], color='grey50', size=segsize)+
  xlim(c(ci.peak.set$lpR6/1e6 - pbuffer, ci.peak.set$upR6/1e6 + pbuffer)) +
...
for(zz in tt)
{
  ...
  TT_peaks <- ggplot(tt.set.s[tt.set.s$sig=='N',], aes(midM, l2F_pool, label=labelrep))+
    geom_segment(data=tt.set.s[tt.set.s$sig=='Y',], x=tt.set.s[tt.set.s$sig=='Y','startp']/1e6, xend=tt.set.s[tt.set.s$sig=='Y','stopp']/1e6, y=tt.set.s[tt.set.s$sig=='Y','log2FoldChange'],yend=tt.set.s[tt.set.s$sig=='Y','log2FoldChange'], color='grey50', size=segsize)+
    xlim(c(ci.peak.set$lpR6/1e6 - pbuffer, ci.peak.set$upR6/1e6 + pbuffer)) +
    geom_point(color='red2', alpha=1/6, size=2)+
    geom_point(data=tt.set.s[tt.set.s$sig=='Y',], aes(midM, l2F_pool), size=2 + 0.5, color='red2')+
