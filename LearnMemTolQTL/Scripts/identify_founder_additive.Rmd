...
There are several DE genes with cis eQTLs in the interval. Several have high effect correlations. No clear candidate. r (some evidence see flybase), shi (lots of evidence see flybase), Gmap (golgi), CG9164 (?), CG6340 (pain response defect), CG9902 (?)

With lots of evidence from flybase: shi 
FC and pval and effect correlation is moderate


CG34325 is most significant,sphe has highest fold change 
...
There are many DE genes in the interval, 8 with cis eQTL. 
...
Most significant DE are the Dpt genes (A & B). Involved in immune response. These do not havea  cis eQTL. Low phenotypic correlations with learning. 
DptA
...
Mes4 also has the highest effect correlation. Though p-value is moderate, not strong. wdp is more significant and has a moderate effect correlation. wdp is related to synaptic target recognition among other things. Mes4 is involved in histone acetylation.
...
Gfrl is significnat, has high effect correlation, some phenotypic correlation.
Gfrl
