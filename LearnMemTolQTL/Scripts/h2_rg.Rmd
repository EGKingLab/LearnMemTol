...
ThermTol.h2 <- h2.lme(geno=as.factor(rawdTT$patRIL), pheno=rawdTT$ThermTolNorm)
...
ThermTol.jk <- jk.h2.lme(geno=as.factor(rawdTT$patRIL), pheno=rawdTT$ThermTolNorm)
...
phen.t <- rawdTT[,c('patRIL','ThermTolNorm','MemoryNorm')] %>% gather(phenotype,value,-patRIL)
